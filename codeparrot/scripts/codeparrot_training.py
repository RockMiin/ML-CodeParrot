...
model = AutoModelForCausalLM.from_pretrained('rockmiin/ml-codeparrot')

if args.gradient_checkpointing:
    model.gradient_checkpointing_enable()
tokenizer = AutoTokenizer.from_pretrained('rockmiin/ml-codeparrot')
